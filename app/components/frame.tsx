  ...
  },
  {
    ...
    icon: (
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
        ...
        <path d="M10 10 L10 3 M10 10 L17 10" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
      </svg>
    ),
  },
];
    ...
    >
      ...
      >
        ...
        {compact ? (
          <>
            <div style={{ flex: 1 }} />
            {/* Single center-aligned cluster so the theme toggle, bell and
                profile all sit on the same vertical line. Without a shared
                alignItems:center wrapper the bell/profile (whose internal
                wrappers have no height) top-align in the stretch row while the
                pill-shaped toggle centers, leaving them misaligned. */}
