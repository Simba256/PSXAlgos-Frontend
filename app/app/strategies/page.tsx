...
type Status = "DEPLOYED" | "DRAFT" | "PAUSED" | "ARCHIVED";
type StatusFilter = "all" | "deployed" | "draft" | "paused" | "archived";
type OutputKind = "bt" | "sig" | "bot";
...
const ALL: Strategy[] = [
  { id: "rsi_bounce_v1", name: "RSI Bounce v1", type: "Mean reversion", status: "DEPLOYED", signals: 3, bt: "+14.2%", sharpe: 1.84, outputs: ["bt", "sig"], universe: "KSE-100", updated: "2m ago", updatedMin: 2 },
  { id: "momentum_breakout", name: "Momentum Breakout", type: "Momentum", status: "DEPLOYED", signals: 2, bt: "+22.7%", sharpe: 2.11, outputs: ["bt", "sig", "bot"], universe: "KSE-100", updated: "14m ago", updatedMin: 14, pinned: true },
  { id: "golden_cross_kse30", name: "Golden Cross · KSE30", type: "Trend follow", status: "DEPLOYED", signals: 1, bt: "+8.1%", sharpe: 1.12, outputs: ["sig"], universe: "KSE-30", updated: "1h ago", updatedMin: 60 },
  { id: "bollinger_squeeze", name: "Bollinger Squeeze", type: "Volatility", status: "DRAFT", signals: 0, bt: "—", sharpe: null, outputs: [], universe: "KSE-100", updated: "3d ago", updatedMin: 60 * 24 * 3 },
  { id: "macd_crossover", name: "MACD Crossover", type: "Momentum", status: "PAUSED", signals: 0, bt: "−2.4%", sharpe: 0.31, outputs: ["bt"], universe: "KSE-100", updated: "1w ago", updatedMin: 60 * 24 * 7 },
  { id: "mean_rev_banks", name: "Mean Rev · Banks", type: "Mean reversion", status: "DEPLOYED", signals: 1, bt: "+9.4%", sharpe: 1.48, outputs: ["bt", "sig"], universe: "Banks", updated: "22m ago", updatedMin: 22 },
  { id: "oil_gas_momentum", name: "Oil & Gas Momentum", type: "Sector momentum", status: "ARCHIVED", signals: 0, bt: "+4.3%", sharpe: 0.82, outputs: ["bt"], universe: "Oil & Gas", updated: "3mo ago", updatedMin: 60 * 24 * 90 },
];
...
export default function StrategiesPage() {
  ...
  const [rows, setRows] = useState<Strategy[]>(ALL);
